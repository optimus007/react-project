...
import { DoubleSide, MathUtils, Object3D } from "three";
...
function Bubble({ factor, speed, xFactor, yFactor, zFactor, rotFactor }) {
  ...
  return <Instance ref={ref} color={Math.random() > 0.5 ? "red" : "yellow"} />;
}
