...
const randomData = Array.from({ length: 1000 }, (r = 5) => ({
  random: Math.random(),
  position: randomVector(r),
  rotation: randomEuler(),
  color: "#" + color.setHSL(Math.random(), 0.5, 0.5).getHexString(),
}))
...
function Shoe({ random, ...props }) {
  ...
  useFrame((state) => {
    ...
    ref.current.scale.setScalar(MathUtils.lerp(ref.current.scale.z, hovered ? 1 : 0.5, 0.1))
